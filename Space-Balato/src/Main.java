    ...
    public static void main(String[] args) {
        ...
        for (int y=0;y<10;y++) { // Loop through the y-axis
            for (int x=0;x<10;x++) { // Loop through the x-axis
                ...
                System.out.print(playerGrid[x][y] + " "); // Prints each cell in the grid
            }
        ...
        for (int y=0;y<10;y++) { // Loop through the y-axis
            for (int x=0;x<10;x++) { // Loop through the x-axis
                ...
                System.out.print(botGrid[x][y] + " "); // Prints each cell in the grid
            }
            System.out.println(); // Go to next line.
        }

        // System.out.println("Hello world!"); // This is a test line for compiling, it will be removed later.
    }
}